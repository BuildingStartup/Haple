...
export default function Profile() {
  ...
  return (
    <section className="min-h-screen space-y-3">
      {/* Navigate so when you go back, it doesn't remount the sellers page and
      the filter still has it's effect */}
      <div>
      ...
      <div className="px-10 mb-5">
        <a
          ...
          rel="noreferrer"
        >
          <button className="bg-[#25D366] w-full text-white py-3 text-base rounded-md flex items-center justify-center gap-2 cursor-pointer">
